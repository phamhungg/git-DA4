                    ...
                    @foreach ( $baiviet as $bv)
                       ...
                       <article class="aa-blog-content-single">                        
                         ...
                         <figure class="aa-blog-img">
                           <a href="{{route('home.baiviet.get_chitietbv',$bv->Mabaiviet)}}"><img src="/asset/fronts/dailyShop/img/Baiviet/{{$bv->Anh}}" alt="fashion img" style="width: 500px;height: 300px"></a>
                         </figure>
                         <p>{{$bv->Tenbaivet}}</p>
