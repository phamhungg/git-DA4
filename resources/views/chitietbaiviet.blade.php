      ...
      <div class="container">
       <div class="aa-catg-head-banner-content">
         ...
         <ol class="breadcrumb">
           ...
           <li class="active">Tin tức chi tiết
                 ...
                 <div class="aa-blog-content aa-blog-details">
                   <article class="aa-blog-content-single">                        
                     ...
                     <figure class="aa-blog-img">
                       <a href="#"><img src="/asset/fronts/dailyShop/img/Baiviet/{{$get_chitietbv->Anh}}" alt="fashion img" style="width: 1000px;height: 500px"></a>
                     </figure>
                     
                     <p>{!!$get_chitietbv->Chitiet!!}</p>
                     {{-- <blockquote>
